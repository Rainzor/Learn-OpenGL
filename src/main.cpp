...
int main() {
    ...
    Shader simpleDepthShader("depthmap.vs", "depthmap.fs");
    Shader debugDepthQuad("debug_depthmap.vs", "debug_depthmap.fs");
    ...
    // load textures
    // -------------
    unsigned int woodTexture = loadTexture("../resources/textures/toy_box_diffuse.png");
